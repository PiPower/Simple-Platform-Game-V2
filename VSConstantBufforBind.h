...
template<typename T>
class VSConstantBufferBind : public BindBase
{
public:
	VSConstantBufferBind(T Data, Graphics* pGFX, UINT slot = 0)
		:
	...
	void Bind()
	{
		GetContext()->VSSetConstantBuffers(slot, 1u, ConstBuff.GetAddressOf());
	}
